    ...
    <section className="relative h-screen min-h-[700px] w-full flex items-center overflow-hidden bg-[#0a0f0a]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mt-16">
        ...
        <div className="lg:col-span-8">
          ...
          >
            <button className="bg-white text-black px-8 py-4 flex items-center gap-3 font-bold uppercase tracking-widest text-xs hover:bg-[#d6852b] hover:text-white transition-all transition duration-400 ease-in-out">
              Our Services <ArrowRight size={16} />
            </button>
            <button className="border border-white/30 text-white px-8 py-4 font-bold uppercase tracking-widest text-xs hover:bg-white hover:text-black transition-all transition duration-400 ease-in-out">
              View Field Projects
            </button>
          </motion.div>
        </div>
